...
export const TRANSLATIONS: Record<Language, ContentTranslation> = {
  ES: {
    ...
    locationHours: 'Cerrado por reformas',
    ...
    footerHours: 'Cerrado por reformas',
  ...
  PT: {
    ...
    locationCopy: 'Copiar',
    locationCopied: 'Copiado!',
    locationHours: 'Fechado para reformas',
    ...
    footerHours: 'Fechado para reformas',
  ...
  EN: {
    ...
    locationHours: 'Closed for renovation',
    ...
    footerHours: 'Closed for renovation',
  ...
  RU: {
    ...
    locationHours: 'Закрыто на ремонт',
